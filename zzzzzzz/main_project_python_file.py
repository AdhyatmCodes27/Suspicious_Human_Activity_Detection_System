# -*- coding: utf-8 -*-
"""Another_copy_of_Human_Action_Recogntion_using_CNN_+_LSTM (1).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1FoG85DCV7PQwC3NwlBGnvTNWT19e3p-Q
...
all_classes_names = os.listdir("D:/UCF50")
...
for counter, random_index in enumerate(random_range, 1):
    ...
    video_files_names_list = os.listdir(f'D:/UCF50/{selected_class_Name}')

    # Randomly select a video file from the list retrieved from the randomly selected Class Directory.
    selected_video_file_name = random.choice(video_files_names_list)

    # Initialize a VideoCapture object to read from the video File.
    video_reader = cv2.VideoCapture(f'D:/UCF50/{selected_class_Name}/{selected_video_file_name}')
...
predict_single_action("D:/v_TaiChi_g03_c01.avi" ,SEQUENCE_LENGTH)

predict_single_action("D:/fight.avi" ,SEQUENCE_LENGTH)

predict_single_action("D:/running.avi" ,SEQUENCE_LENGTH)

predict_single_action("D:/walking.avi" ,SEQUENCE_LENGTH)

video_clip = VideoFileClip("D:/fight.avi", audio=False)
video_clip.preview()

video_clip = VideoFileClip("D:/v_TaiChi_g03_c01.avi", audio=False)
video_clip.preview()

video_clip = VideoFileClip("D:/walking.avi", audio=False)
video_clip.preview()

video_clip = VideoFileClip("D:/running.avi", audio=False)
video_clip.preview()
...
# Commented out IPython magic to ensure Python compatibility.
# %%time
predict_on_video("D:/Human-Activity.avi","Human-Activity-Prediction.avi",SEQUENCE_LENGTH)
...
#     video_file_path = st.file_uploader("Upload a video file", type=["mp4"])
...
#             output_file_path = "output.avi"  # Define the output video file path
#             SEQUENCE_LENGTH = 16  # Define the sequence length
#             predict_on_video(video_file_path, output_file_path, SEQUENCE_LENGTH)
#             st.success("Prediction complete. Output video saved as output.avi")

#             # Send email alert
#             predicted_class_name = "Suspicious Activity"  # Replace with actual prediction
#             send_alert(predicted_class_name)
#             st.success("Email alert sent.")

#             # Sound the alarm
#             send_alarm(predicted_class_name)
#             st.success("Alarm sounded.")
...
# ! ngrok authtoken 2X86RTE5OtA880NdgJEBfSRQWub_F8zQ3sSXgScG967Cjuha
